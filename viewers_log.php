...
function reverse_geocode($lat, $lng) {
    ...
    curl_setopt($ch, CURLOPT_HTTPHEADER, [
        "User-Agent: DearSea-Viewer-Log/1.0"
    ]);
...
function send_to_telegram($data) {
    ...
    $message =
        "<b>👁️ DearSea WEBSITE VIEWER LOG</b>\n\n" . 
...
function send_to_discord($data) {
    ...
    $payload = [
        "content" => "👁️ **New DearSea Website Viewer Log**",
        "embeds" => [
            [
                "title" => "DearSea Website Viewer Log",
                "color" => 11740787,
                "fields" => [
                    [
...
[
    ...
    "inline" => false
                ...
                "footer" => [
                    "text" => "DearSea Viewer Notification System"
                ],
                "timestamp" => date("c")
            ]
        ]
